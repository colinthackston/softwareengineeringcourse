...
class Player:
    ...
    def select_score_option(self, score_options):
        ...
        score_selected = pyip.inputMenu(score_options, numbered=True, blank=True)
    ...
    def select_score(self, final_roll):
        ...
        while double_check is False:
            ...
            confirm_score_selected = self.confirm_score_selected(score_selected)
